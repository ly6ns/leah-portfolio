      ...
      <main>
        <div>
          ...
          <div className={styles.topContainer}>
            ...
            <p className={styles.content}> I tend to believe that there are not any problems that cannot be solved. My background as a Special Education 
                Teacher gives me tremendous patience and a willingness to persevere and find a way. For me, design is no different.
            </p>
            <p className={styles.content}> My fatal flaw is asking a lot of questions. I’ve spent my time as a designer listening to clients and users, 
                learning from their feedback, and asking questions for clarification and verification, all in service of creating 
                the best possible digital interface that they love and users want to explore.
            </p>
            <p className={styles.content}> When I’m not pushing pixels on a screen, you can find me riding my bike across the five boroughs, reading, or in 
                some sort of body of water, playing and living my best mermaid life.
            </p>
